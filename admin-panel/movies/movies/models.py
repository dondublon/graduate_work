...
class FilmWork(UUIDMixin, TimeStampedMixin):
    ...
    description = models.TextField(_("description"), blank=True, null=True)
    creation_date = models.DateField(_("creation date"), blank=True, null=True, db_index=True)
...
class GenreFilmWork(UUIDMixin):
    film_work = models.ForeignKey(FilmWork, on_delete=models.CASCADE, related_name="genres")
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=["film_work_id", "genre_id"], name="genre_film_work_idx_unique"),
        ]
        indexes = [
