...
from resources import auth, profile, login_history, role, user_role, users_emails
...
auth_api.add_resource(users_emails.UsersEmailsResource, "/users-emails")
...
swagger.add_namespace(users_emails.ns, "/users-emails")
